...
Most often we find ourselves using certain charts to explore data. These charts may have different variations depending on what you are exploring.
...
# ggsave("cluttered_chart.png", bg="white", units="in", width=9, height=6, path = here('image'))
```
